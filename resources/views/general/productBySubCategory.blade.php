@extends('layouts.general.productByCategoryMaster')
@section('content')
    @foreach($products as $product)
    <main class="main">
        	<div class="page-header text-center" style="background-image: url({{ url('uploads/subCategories/'.$subCategory->image) }});">
                <div style="max-width:500px;" class="container-fluid">
        			<h1 class="page-title" style="color: #ffffff; font-weight:bold; background: #3399ff; border-radius: 10px;">{{ $subCategory->name }}</h1>
                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="/product/{{$product->id}}">
                                            <img src="{{ asset('uploads/products/'.$product->image) }}" alt="Product image" class="product-image" style="height: 320px">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="product/{{$product->category->id}}">{{ $product->category->name }}</a>
                                        </div><!-- End .product-cat -->
                            ...
                            {{-- <div class="col-6 col-md-4 col-lg-4 col-xl-3 col-xxl-2">
                                <div class="product">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('general/assets/images/products/product-3.jpg') }}" alt="Product image" class="product-image">
                                        </a>
